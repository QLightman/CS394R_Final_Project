...
def trainNetwork(s, readout,s_2,readout_2, sess ):
    ...
    # readout_action_2 = tf.reduce_sum(tf.multiply(readout_2, a), reduction_indices=1)
    # cost_2 = tf.reduce_mean(tf.square(y - readout_action_2))
    # train_step_2 = tf.train.AdamOptimizer(1e-6).minimize(cost_2)
    ...
    while "flappy bird" != "angry bird":
        ...
        if t % 10000 == 0:
            saver.save(sess, 'saved_networks/' + GAME_2019 + '-dqn', global_step = t)
